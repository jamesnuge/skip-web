...
const locations: { [key: string]: number } = {
    "Sydney Dragway": 239,
    "Willowbank Raceway QLD": 180,
    "Perth Motorplex": 2203,
    "Hidden Valley Darwin": 39,
    "The Bend Motorsport Park": 71,
    "Heathcote Park Raceway Melbourne": 596,
    "Adelaide International Raceway": 2008
};
